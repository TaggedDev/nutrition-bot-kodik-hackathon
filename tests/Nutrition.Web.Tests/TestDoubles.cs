...
internal sealed class FakeUserManager : UserManager<ApplicationUser>
{
    ...
    private sealed class DummyUserStore : IUserStore<ApplicationUser>, IUserEmailStore<ApplicationUser>, IUserPasswordStore<ApplicationUser>
    {
        ...
        public Task<bool> GetEmailConfirmedAsync(ApplicationUser user, CancellationToken cancellationToken) => Task.FromResult(false);
        ...
        public Task<ApplicationUser?> FindByEmailAsync(string normalizedEmail, CancellationToken cancellationToken) => throw new NotSupportedException();
...
{
    public FakeSignInManager(FakeUserManager userManager) : base(
        userManager,
